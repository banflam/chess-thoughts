...
const quotes: Quote[] = [
  ...
  [
    "You must take your opponent into a deep, dark forest where 2+2 is 5 and the path leading out is only wide enough for one.",
    "Mikhail Tal",
  ],
  ...
  [
    "I got locked up when I was living in Maryland, selling drugs and stuff. But that doesn't mean that the game was over. That's how I equate chess with life.",
    "Marcel Anderson, chess hustler",
  ],

  [
    "My girlfriend said, ‘It’s either me or the chess pieces, Marcel.’... I looked at my chess pieces, I looked at her again. And the more I'm looking at her, the more I can see how toxic she is. The more I look at my chess pieces, I can see lots of solitude. I say, “You know what? I'll talk to you later.” I picked up my pieces, I left.",
    "Marcel Anderson, chess hustler",
  ],

  [
    "I threw my phone off the Brooklyn Bridge. You need to give the game your full attention.",
    "Ambakisye Osayaba, chess hustler",
  ],
